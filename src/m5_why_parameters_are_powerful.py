...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50),7,16,"blue",15)
    even_better_draw_circles(rg.Point(-200,0),5,25,"pink",1)
    window.update()
...
def better_draw_circles(point,disttonext):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(disttonext)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(disttonext * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,disttonext,numberoc,c,t):
    ...
    for k in range(1, numberoc):  # k becomes 1, 2, 3, ... 10
