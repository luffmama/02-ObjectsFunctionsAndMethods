...
def try_methods():
    browtur = rg.SimpleTurtle()
    browtur.pen = rg.Pen("brown",5)
    browtur.forward(150)
    browtur.left(90)
    browtur.forward(50)
    browtur.backward(100)
...
def try_methods_and_functions():
    ...
    will.pen = rg.Pen("blue",5)
    will.backward(150)
    will.speed = 1
    draw_many_squares(will,2,100,30)
    will.speed = 5
    will.pen = rg.Pen("red",5)
    draw_many_squares(will,10,50,15)
    will.speed = 100
    will.pen = rg.Pen("red", 35)
    draw_many_squares(will,8,300,60)
    will.pen = rg.Pen("black",3)
    will.backward(200)
    will.draw_circle(30)
    will.draw_square(50)
    """
